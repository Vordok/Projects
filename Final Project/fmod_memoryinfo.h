...
typedef enum
{
    ...
    FMOD_MEMTYPE_FILE                  = 8,      /* Codecs allocated for streaming */
    ...
    FMOD_MEMTYPE_STREAMINSTANCE        = 20,     /* Stream objects and internals */
    ...
    FMOD_MEMTYPE_EVENTINSTANCE_LAYER   = 30,     /* Event layer instance objects */
