...
//Cromo
GLfloat crAmb[4] = {0.25f, 0.25f, 0.25f, 1.0f};//componente ambiental
GLfloat crDif[4] = {0.4f, 0.4f, 0.4f, 1.0f};//componente difusa
GLfloat crSpe[4] = {0.774597f, 0.774597f, 0.774597f, 1.0f};//componente especular
GLfloat crShi = 90.8f;//brillo
...
//Oro
GLfloat oroAmb[4] = {0.57f,0.40f,0.0f,1.0f};
GLfloat oroDif[4] = {0.22f,0.15f,0.0f,1.0f};
GLfloat oroSpe[4] = {0.71f,0.70f,0.56f,1.0f};
GLfloat oroShi = 20.0f;
...
//Plata
GLfloat plataAmb[4] = {0.30f,0.30f,0.35f,1.0f};
GLfloat plataDif[4]	= {0.30f,0.30f,0.50f,1.0f};
GLfloat plataSpe[4] = {0.70f,0.70f,0.85f,1.0f};
GLfloat plataShi	= 20.0f;
...
void CMateriales::SeleccionaMaterial(int tipo)
{
	...
	{
		//Cromo
		glMaterialfv(GL_FRONT, GL_AMBIENT, crAmb);
		glMaterialfv(GL_FRONT, GL_DIFFUSE, crDif);
		glMaterialfv(GL_FRONT, GL_SPECULAR, crSpe);
		glMaterialf(GL_FRONT, GL_SHININESS, crShi);
	}
	else if(tipo == 9)
	{
		//Bronce
